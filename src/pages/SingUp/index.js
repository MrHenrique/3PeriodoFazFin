...
function SingUp({navigation}){
  ...
  const [passordConfirm, setPasswordConfirm] = useState([]);
  ...
  function handleUserRegistrer(){
    ...
    if (password.trim() !== passordConfirm.trim()){
      ...
      >
        <View style={styles.containerlogin}>
          ...
          <TouchableOpacity
              ...
              onPress={handleUserRegistrer}
              on
            >
              <Text style={styles.tituloBotao}>{"Cadatrar"}</Text>
            </TouchableOpacity>
