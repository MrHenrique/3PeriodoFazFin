...
function BezierChartFaturamentoReb() {
  ...
  useEffect(() => {
    const listaTeste = listaLeiteReb.filter((item) => {
      ...
      return (
        itemDataDeCriacao.getMonth() === 2 || itemDataDeCriacao.getMonth() === 3
      ); // verifica se o mês do item é igual ao escolhido pelo usuário
    });
